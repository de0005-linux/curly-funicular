توسعه و بروزرسانی توسط : https://github.com/de0005-linux
# 🚀 Panel

دروازه (Gateway) سریع و مدرن برای تونل‌زنی VLESS روی WebSocket و XHTTP + HTTP Proxy، با داشبورد مدیریتی، **بات فروش تلگرام**، کیف پول، خرید و تمدید، صفحات ساب و قابلیت ساخت لینک‌های اختصاصی.
